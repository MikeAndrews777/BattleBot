...
namespace Application
{
    public static class QMAProgram
    {
        ...
        public static UInt16 lightsensorval = 0, ultrasonicsensorval = 0, alightCheck = 0;
        ...
        static void straightenOut()
        {
            ...
            if (alightCheck > 3 && ultrasonicsensorval < 7)
            {
                ...
                UK.Sensor1.Reset();
                UK.Sensor2.Reset();
                UK.MotorA.On(70, 1160, false); //2320 with Mike's surface
                UK.MotorD.On(70, 1160, false);
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                UK.Beep(100, 1000);  //beeps when cheese is found
